    ...
    >
      ...
      <div className="flex-1 flex flex-col ml-1">
        ...
        <div
          ...
          className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-900"
        >
          {hasActivity ? (
            <>
              {/* Reasoning Section */}
            ...
            <div className="flex flex-col items-center justify-center h-full text-center px-6 py-12">
              ...
              <h3 className="text-sm font-medium text-slate-400 mb-2">No Activity Yet</h3>
