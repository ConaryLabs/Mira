...
///
/// nomic-embed-text has an 8192-token context window. Dense C# code tokenizes at
/// ~2 chars/token (BPE splits camelCase identifiers into sub-tokens), so 8192 tokens
/// ≈ 16384 chars. We use 12000 chars (≈6000 tokens at worst-case density) for a
/// comfortable safety margin. Full chunk content is always stored in the database —
