...
// NOTE: hook_pre_tool_no_panic and hook_user_prompt_no_panic tests removed
// because the PreToolUse and UserPromptSubmit hooks were removed in the
// script-runner refactor (Task 9).
