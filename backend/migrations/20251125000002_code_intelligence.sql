...
CREATE INDEX IF NOT EXISTS idx_code_elements_file_id ON code_elements(file_id);
...
CREATE INDEX IF NOT EXISTS idx_code_elements_start_line ON code_elements(start_line);
...
CREATE INDEX IF NOT EXISTS idx_external_dependencies_import ON external_dependencies(import_path);
