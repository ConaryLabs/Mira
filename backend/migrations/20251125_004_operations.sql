...
CREATE INDEX IF NOT EXISTS idx_file_modifications_type ON file_modifications(modification_type);
CREATE INDEX IF NOT EXISTS idx_file_modifications_created ON file_modifications(created_at);
