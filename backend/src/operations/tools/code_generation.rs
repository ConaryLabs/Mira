// src/operations/tools/code_generation.rs
// Code generation tool schemas (generate, refactor, debug)

use serde_json::Value;
use crate::operations::tool_builder::{ToolBuilder, properties};

/// Get all code generation tool schemas
...
pub fn generate_code_tool() -> Value {
    ToolBuilder::new(
        "generate_code",
...
pub fn refactor_code_tool() -> Value {
    ToolBuilder::new(
        "refactor_code",
