...
pub use chunker::{ChunkingStrategy, DocumentChunker};
pub use parser::{DocumentParser, RawDocument};
pub use storage::{DocumentRecord, DocumentSearchResult, DocumentStorage};
...
impl DocumentProcessor {
    ...
    pub async fn process_document(
        ...
        let chunks = self
            .chunker
            .chunk_document(&raw_document.content, Some(&raw_document.metadata))?;
    ...
    pub async fn search_documents(
        ...
        self.storage
            .search_documents(project_id, query, limit)
            .await
    }
