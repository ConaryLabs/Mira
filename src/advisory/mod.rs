...
impl AdvisoryService {
    ...
    pub async fn ask_with_tools(
        ...
        match model {
            ...
            AdvisoryModel::Opus45 => self.ask_with_tools_opus(message, system, ctx).await,
        }
    }
    ...
    async fn ask_with_tools_opus(
        ...
        timeout(
            Duration::from_secs(TOOL_LOOP_TIMEOUT_SECS),
            self.ask_with_tools_opus_inner(message, system, ctx),
        )
        .await
    ...
    async fn ask_with_tools_opus_inner(
        ...
        use providers::{OpusInputItem, OpusToolUse};
