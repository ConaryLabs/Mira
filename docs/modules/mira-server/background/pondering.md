...
| Module | Purpose |
|--------|---------|
| `queries` | DB queries for stale goals, fragile modules, revert clusters, recurring errors |
| `heuristic` | Threshold-based insight generation from factual DB signals |
